...
where p.uid = 'yDuAzyqYABS'
				and (to_char(tei.created, 'YYYY-MM') = '2024-04'
									or to_char(tei.lastupdated, 'YYYY-MM') = '2024-04'
									or to_char(psi.created, 'YYYY-MM') = '2024-04'
									or to_char(psi.lastupdated, 'YYYY-MM') = '2024-04');
